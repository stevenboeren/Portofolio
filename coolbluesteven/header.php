...
<nav class="nav-bg fixed w-full">
  <div class="max-w-8xl mx-auto px-4">
    <div class="flex justify-between">
      ...
      <div class="flex">
        <!-- logo -->
        <div>
          <a href="#" class="flex items-center py-3 px-2 txt-white ">
            <span>STEVEN</span>
          </a>
        </div>
      ...
      <div class="hidden md:flex items-center ">
        <a href="" class="py-3 px-3 txt-white">PROJECTS</a>
        <a href="" class="py-3 px-3 txt-white">ABOUT ME</a>
        <a href="" class="py-3 px-3 txt-white">CONTACT</a>
  ...
  <div class="mobile-menu hidden md:hidden mobile-menu-nav" >
    <a href="#" class="block py-2 px-4 text-sm txt-white">PROJECTS</a>
    <a href="#" class="block py-2 px-4 text-sm txt-white">ABOUT ME</a>
    <a href="#" class="block py-2 px-4 text-sm txt-white">CONTACT</a>
  </div>
</nav>
    ...
    <div class="slideshow-inner">
      <div class="slides">
        ...
        <div class="slide">
          <div class="slide-content">
            <div class="caption">
              <div class="title">Mijn Programmer-projecten</div>
              <div class="text">
